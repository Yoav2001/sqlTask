...
export type GetAllPostsOfUserByEmail = (email: Post["posterEmailUser"])  => Promise<Post[] | undefined>;
export type GetAllPosts = () => Promise<Post[]>;
export type AddPost = (post: Post) =>  Promise<AddPostResult>;
export type DeletePost = (email: Post["posterEmailUser"]) => Promise<DeletePostResult>;
